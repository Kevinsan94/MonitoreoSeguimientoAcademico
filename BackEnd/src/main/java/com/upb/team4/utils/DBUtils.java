...
public class DBUtils {
    ...
    public static Boolean verificatedUser(String code, String pass) throws ClassNotFoundException{
        ...
        try {
            String sql = "Select id_estudiante, contrase�a from estudiante"
                    +" where id_estudiante = '"+code+"' and contrase�a = '"+pass+"';";
    ...
    public static void crearAlumno(String nombre, String apellido, int telefono, String email, String password) throws ClassNotFoundException{
        ...
        String sql = "insert into estudiante (nombre, apellido, telefono, email, contrase�a) values('"+nombre+"' ,"
    ...
    public static void modificarAlumno(Student e) throws ClassNotFoundException{
        String sql = "update estudiante set nombre='"+e.getName()+"', apellido ='"+e.getLastname()+"',"
                +"telefono = '"+e.getEmail()+"',email= '"+e.getNumber()+"'contrase�a= '"+e.getPassword()+"' where id_estudiante='"+e.getCode()+"';";
        DBConn.getDB().setUpdate(sql);
    }
    ...
    public static Student findAlumno(String code) throws ClassNotFoundException {
        ...
        try {
            if (st.next()){
                ...
                String pass = st.getString("contrase�a");
                alumno = new Student();
